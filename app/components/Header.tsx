    ...
    <header className="nav">
      <div className="container nav-inner">
        <Link href="/" className="logo" onClick={close}>
          That&apos;s Okay<span className="logo-dot">.</span>
        </Link>
        ...
        <nav className="nav-links" aria-label="Main navigation">
          ...
          <div className="nav-services">
            <button className="nav-services-trigger" type="button" aria-haspopup="true">
              Services <span aria-hidden="true"><b>⌵</b></span>
            </button>
      ...
      <div className={`mobile-menu ${open ? "is-open" : ""}`}>
        ...
        <div className="mobile-menu-group">
          <span>Services</span>
          <Link href="/individuals" onClick={close}>Individuals</Link>
          <Link href="/organisations" onClick={close}>Organisations</Link>
        </div>
